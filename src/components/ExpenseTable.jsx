        ...
        <div className="flex overflow-x-hidden">
            ...
            <table className="w-full p-3" onClick={() => setContextPosition({})}>
                <thead className="bg-gray-50">
                    <tr>
                        <th className="py-3 px-6 text-center text-xs font-medium text-gray-900 uppercase tracking-wider">
                           Title
                        </th>
                        <th className="py-3 px-6 text-center text-xs font-medium text-gray-900 uppercase tracking-wider">
                        ...
                        <th className="px-3 py-3 text-center text-xs font-medium text-gray-900 uppercase tracking-wider">
                            Amount 
